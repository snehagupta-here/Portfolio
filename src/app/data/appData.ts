import type { DetailedAchievement } from "@/app/types/achievements";
...
export const detailedAchievements: DetailedAchievement[] = [
  {
    _id: "ach_001",
    user_id: "user_001",
    achievement_date: "2025-11-15",
    title: "Grand Prize Winner — AI Accessibility Tool",
    position: PositionEnum.FIRST,
    description:
      "Led a team of 4 to build an AI-powered accessibility tool that helps visually impaired users navigate the web through voice commands and intelligent screen reading. Outperformed 500+ teams from 40 countries, winning the grand prize and a $50,000 funding grant. Our solution leverages OpenAI Whisper for voice processing and GPT-4 Vision for context-aware page interpretation.",
    competition_name: "Global Hackathon 2025",
    images: [
      {
        url: "https://images.unsplash.com/photo-1591115765373-5207764f72e7?w=1200&h=800&fit=crop",
        alt: "Team accepting trophy on stage",
        caption: "Receiving the grand prize trophy",
      },
      {
        url: "https://images.unsplash.com/photo-1559223607-a43c990c692c?w=1200&h=800&fit=crop",
        alt: "Product demo screen",
        caption: "Live product demonstration",
      },
      {
        url: "https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=1200&h=800&fit=crop",
        alt: "Team celebrating win",
        caption: "Team celebration moment",
      },
    ],
    certificate_url: {
      url: "https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?w=1200&h=900&fit=crop",
  ...
  },
  {
    _id: "ach_002",
    user_id: "user_001",
    achievement_date: "2025-09-22",
    title: "Innovation Award — Real-time Collaboration Platform",
    position: PositionEnum.WINNER,
    description:
      "Recognized for developing a revolutionary approach to real-time collaboration in distributed teams. Built a low-latency synchronization engine using CRDTs and WebRTC that scales to thousands of concurrent editors. Award presented by leading industry experts and venture capitalists.",
    competition_name: "TechCrunch Disrupt 2025",
    images: [
      {
        url: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1200&h=800&fit=crop",
        alt: "Conference stage award",
        caption: "TechCrunch Disrupt main stage",
      },
      {
    ...
    certificate_url: {
      url: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=1200&h=900&fit=crop",
  ...
  },
  {
    ...
    title: "Best UI/UX Design — Component Library",
    position: PositionEnum.FIRST,
    description:
      "Created an award-winning design system that combines accessibility with stunning visual aesthetics. The library includes 80+ components, full dark/light theme support, and meets WCAG 2.1 AAA standards. Now used by over 200 development teams worldwide.",
    competition_name: "React Summit Hackathon 2025",
    images: [
      {
        url: "https://images.unsplash.com/photo-1561070791-2526d30994b8?w=1200&h=800&fit=crop",
        alt: "Design system showcase",
        caption: "Component library overview",
      },
      {
        url: "https://images.unsplash.com/photo-1559028012-481c04fa702d?w=1200&h=800&fit=crop",
        alt: "Design tokens",
        caption: "Design token architecture",
      },
      {
        url: "https://images.unsplash.com/photo-1587440871875-191322ee64b0?w=1200&h=800&fit=crop",
        alt: "Theme variants",
        caption: "Multiple theme variants",
      },
    ],
    certificate_url: {
      url: "https://images.unsplash.com/photo-1589330694653-ded6df03f754?w=1200&h=900&fit=crop",
  ...
  },
  {
    _id: "ach_004",
    user_id: "user_001",
    achievement_date: "2025-03-18",
    title: "Runner Up — Food Waste Prediction Model",
    position: PositionEnum.SECOND,
    description:
      "Developed a machine learning model to predict and prevent food waste in supply chains. The model achieved 92% accuracy in predicting spoilage risk and has been piloted by 3 major grocery chains. Estimated to reduce food waste by 30% in tested markets.",
    competition_name: "AI for Good Challenge 2025",
    images: [
      {
        url: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&h=800&fit=crop",
        alt: "Food waste analytics",
        caption: "ML model dashboard",
      },
      {
        url: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=1200&h=800&fit=crop",
        alt: "Supply chain visualization",
        caption: "Supply chain optimization view",
      },
    ],
    certificate_url: {
      url: "https://images.unsplash.com/photo-1606326608690-4e0281b1e588?w=1200&h=900&fit=crop",
      alt: "Runner up certificate",
    },
  ...
  },
  {
    _id: "ach_005",
    user_id: "user_001",
    achievement_date: "2025-01-25",
    title: "Community Choice Award — Form Validation Library",
    position: PositionEnum.WINNER,
    description:
      "Contributed a widely-adopted open source library for handling complex form validations in React applications. The library has 15k+ GitHub stars, 500k+ weekly npm downloads, and is used by companies like Vercel, Stripe, and Shopify. Voted #1 by the developer community.",
    competition_name: "Open Source Summit 2025",
    images: [
      {
        url: "https://images.unsplash.com/photo-1556075798-4825dfaaf498?w=1200&h=800&fit=crop",
        alt: "GitHub repository stats",
        caption: "Repository milestone celebration",
      },
      {
        url: "https://images.unsplash.com/photo-1531482615713-2afd69097998?w=1200&h=800&fit=crop",
        alt: "Community gathering",
        caption: "Open Source Summit community",
      },
      {
        url: "https://images.unsplash.com/photo-1517048676732-d65bc937f952?w=1200&h=800&fit=crop",
        alt: "Award ceremony",
        caption: "Receiving the community award",
      },
    ],
    certificate_url: {
      url: "https://images.unsplash.com/photo-1599582909646-2d99fb55d6dc?w=1200&h=900&fit=crop",
      alt: "Community choice certificate",
    },
  ...
  },
  {
    _id: "ach_006",
    user_id: "user_001",
    achievement_date: "2024-12-05",
    title: "Finalist — Blockchain Identity Solution",
    position: PositionEnum.FINALIST,
    description:
      "Reached the finals with a decentralized identity verification system built on Ethereum. The solution uses zero-knowledge proofs to verify credentials without exposing personal data, providing privacy-first authentication for Web3 applications.",
    competition_name: "ETHGlobal Hackathon 2024",
    images: [
      {
        url: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=1200&h=800&fit=crop",
        alt: "Blockchain visualization",
        caption: "Identity verification flow",
      },
      {
        url: "https://images.unsplash.com/photo-1639322537228-f710d846310a?w=1200&h=800&fit=crop",
        alt: "Smart contract code",
        caption: "Solidity smart contracts",
      },
    ],
...
export const getAchievementById = (id: string): DetailedAchievement | undefined =>
  detailedAchievements.find((a) => a._id === id);

// Returns a Tailwind gradient class string used by the Achievements UI.
export const getPositionColor = (position: PositionEnum): string => {
  switch (position) {
    case PositionEnum.FIRST:
      return "from-primary to-accent";
    case PositionEnum.SECOND:
      return "from-platinum to-muted-foreground";
    case PositionEnum.THIRD:
      return "from-rose-gold to-amber";
    case PositionEnum.WINNER:
      return "from-emerald to-blue-glow";
    case PositionEnum.RUNNER_UP:
      return "from-amber to-rose-gold";
    case PositionEnum.FINALIST:
